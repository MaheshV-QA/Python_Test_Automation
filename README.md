...
- `pytest/` - Pytest automation framework, page objects, utilities, and sample tests.
...
- `pytest/utilities/Browser_setup.py` now cleans up browser sessions with a yield fixture.
- `pytest/utilities/ReadProperties.py` loads config relative to its own location.
- `pytest/Testcases/Test_Login.py` now uses the fixture instance correctly.
...
- Add a root-level `pytest.ini` or root `pytest/__init__.py` if you want package-style imports.
